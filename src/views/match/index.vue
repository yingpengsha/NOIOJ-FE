  ...
  <div id="match">
    ...
    <section id="intro">
      <el-card class="box-card">
        <div class="text item">
          <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;模拟竞赛在形式和题量上接近NOI竞赛，通过模拟竞赛，同学们在学习上的弱点和不足以及自己复习的漏洞清楚地表现出来，还可以正确的评估自己的水平。同时同学们也锻炼了自己的竞赛心态和竞赛技巧，训练自己的答题规范化和适应竞赛压力积累考试经验，让同学快速进入考试状态。通过竞赛历史可以把错题整理出来，经常翻看，从而有效地防止“一错再错”的现象。</p>
        </div>
      </el-card>
    </section>
